...
namespace ORB_SLAM2 {
    ...
    Tracking::Tracking(System *pSys, ORBVocabulary *pVoc, Map *pMap,
            ...
            mpMap(pMap), mnLastRelocFrameId(0), tIsDynamicObjectRemoval (isDynamicObjectRemoval), RobustFeatureSearch (isRobustFeatureSearch),
...
//    cout << "Computed the BoW for this frame" << endl;
        ...
        if (RobustFeatureSearch == true)
        {
            ...
            float starting_position[3] = {0, 0, 0};
