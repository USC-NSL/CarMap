...
//    cout << "In Sim3Solver" << endl;
    ...
    for(int i1=0; i1<mN1; i1++)
    {
        if(vpMatched12[i1])
        {
            ...
            cv::KeyPoint kp2_value;

            if (pKF2->isLoadedFromDisk)
            {
                kp2_value = pMP1->GetMpObservations().find(pKF1)->second.Keypoint;
            }
            else
                kp2_value = pKF2->mvKeysUn[indexKF2];


//            const cv::KeyPoint &myKP1 = pMP1->GetMpObservations().find(pKF1)->second.Keypoint;
//            const cv::KeyPoint &myKP2 = pMP2->GetMpObservations().find(pKF2)->second.Keypoint;

            const cv::KeyPoint &kp1 = pKF1->mvKeysUn[indexKF1];

            const cv::KeyPoint &kp2 = kp2_value;

//            if ((myKP1.pt.y - kp1.pt.y > 1) || (myKP1.pt.x - kp1.pt.x > 1))
//            {
//                cout << "1 = " << kp2.pt.x << ", " << kp2.pt.y << endl;
//                cout << "2 = " << myKP2.pt.x << ", " << myKP2.pt.y << endl;
//
//            } else
//            {
//                cout << "they check out" << endl;
//                cout << "1 = " << kp2.pt.x << ", " << kp2.pt.y << endl;
//                cout << "2 = " << myKP2.pt.x << ", " << myKP2.pt.y << endl;
//            }

//                cerr << "HUGEEEEE PROBLEM BROOOOO!" << endl;

            const float sigmaSquare1 = pKF1->mvLevelSigma2[kp1.octave];
            const float sigmaSquare2 = pKF2->mvLevelSigma2[kp2.octave];

//            if (kp1.octave != myKP1.octave || kp2.octave != myKP2.octave)
//                cerr << "HUGEEEE PROBLEM AGAIN BROOOO!" << endl;
