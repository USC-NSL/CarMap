...
namespace ORB_SLAM2
{
    ...
    public:
        ...
        // Map update
        void MapUpdate (std::ofstream* e2e_logger, bool reset_mapping = true);

        void SendMapAndReset(std::ofstream* e2e_logger, bool reset_mapping = true);
    ...
    private:
        ...
        const string vehicle_ip_address;
        ...
        bool upload_map_to_cloud_service;
    };
