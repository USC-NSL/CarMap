...
public:
    ...
    MapPoint(const cv::Mat &newPos, unsigned int kf_id, Map* pMap, int numberOfObservations, cv::Mat desc, unsigned char semanticLabel);
    ...
    // Semantic label
    unsigned char GetSemanticLabel ();
    ...
    void ReplaceReferenceKeyFrameInBaseMap (KeyFrame*); //Replace the reference keyframe of this map point in the base map
